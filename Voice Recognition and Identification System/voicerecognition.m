...
% By  Sachin Dharankar,Jaisingh Dhande,Aishwarya
% Zaregaonkar,Ruchika Kale,Parth Mhakavekar & Neha Mothe.
%--------------------------------------------------------------------------
...
disp('By  Sachin Dharankar,Jaisingh Dhande,Neha Mothe,Aishwarya Zaregaonkar,Ruchika Kale & Parth Mhakavekar.');
disp(' ');
pause(0.5);
disp('LOADING ');
pause(1);
        ...
        while ch2~=4
            ...
            if ch2==1
                ...
                while ch3~=9
                    ...
                    if ch3~=9
                        p=audioplayer(str{ch3},fstr{ch3});
                        play(p);
                    end
                end
            end
            ...
            if ch2==2
                ...
                while ch3~=9
                    ch3=menu('Test :','Signal 1','Signal 2','Signal 3',...
                        'Signal 4','Signal 5','Signal 6','Signal 7','Signal 8','Exit');
                    if ch3~=9
                        p=audioplayer(ste{ch3},fste{ch3});
                        play(p);
                    end
                end
                close all;
...
% All 8 samples data values are loaded in file sounddatabase1.dat.
        ...
        for sound_number = 1: 8
            ...
            if sound_number == 1;
                ...
                save('sound_database1.dat','data','sound_number','fs','-append');
            end
        end
...
%% 10.1 Add a new sound from microphone
            ...
            if chos==1
                ...
                if (exist('sound_database.dat','file')==2)
                    ...
                    audiowrite(st,j,samplingfrequency)
