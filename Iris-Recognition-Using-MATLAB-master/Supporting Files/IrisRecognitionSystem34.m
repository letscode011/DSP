%%%Image Aquisition Process:-DIFFERENT IRIS
clc; clear all; close all; warning off;

[FileName1,FilePath1] = uigetfile('*.jpg','Select the 1st Iris Image');
...
c=imcrop(g,[276 187 820-276 538-187]);
subplot(1,2,1);
imshow(c);
title('STEP:5 Croped Image:1');

cc=imcrop(gg,[137 102 616-137 352-102]);
subplot(1,2,2);
imshow(cc);
...
n=imread('normal3.jpg');
subplot(2,1,1);
imshow(n);
title('STEP:13 Normalized Image:1')

nn=imread('normal4.jpg');
subplot(2,1,2);
imshow(nn);
